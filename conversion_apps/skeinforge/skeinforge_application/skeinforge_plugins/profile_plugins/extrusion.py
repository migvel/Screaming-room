...
def getCraftSequence():
	...
	return 'carve scale bottom preface widen inset fill multiply speed temperature raft skirt chamber tower jitter clip smooth stretch skin joris comb cool hop wipe oozebane splodge home lash fillet limit unpause dimension alteration export'.split()
